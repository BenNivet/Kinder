...
package com.example.b_can.FirstAppliSwipe.SwipeToDismiss;
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
     ...
     */
    public SwipeDismissListViewTouchListener(ListView listView, DismissCallbacks callbacks, boolean right) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                //swipe only if right swipe
                if((right && deltaX < 0) || (!right && deltaX > 0) ) {
